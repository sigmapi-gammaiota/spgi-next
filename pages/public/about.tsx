...
export default function Page() {
  return (
    <div className="grid grid-cols-3 p-4 items-center bg-base1 shadow-md rounded-lg">

      <h1 className="col-span-full py-4 text-center bg-purp0 text-5xl text-base0 rounded-t-lg">Our History</h1>

      <h2 className="text-3xl col-span-full py-4 text-center">Founding</h2>
      ...
      <h2 className="text-3xl col-span-full py-4 text-center">Rebuilding Our Chapter</h2>
      ...
      <h2 className="text-3xl col-span-full py-4 text-center">Growth and Success</h2>
      <div className="col-span-full py-4">
      ...
      <h2 className="text-3xl col-span-full py-4 text-center">Present Day</h2>
      <div className="col-span-full py-4">
      ...
      <h2 className="text-3xl col-span-full py-4 text-center">International History</h2>
      <div className="col-span-full py-4 rounded-b-lg">
