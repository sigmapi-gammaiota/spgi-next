...
export default function Page() {
  return (
    <div className="grid shadow-md rounded-lg">
      ...
      <div className="py-16 px-8 md:px-16 bg-neutral-200 flex gap-6 bg-base1">
      ...
      <div className="py-16 px-8 md:px-16 bg-base0">
      ...
      <div className="py-16 px-8 md:px-16 bg-base1 flex flex-wrap gap-6">
        <div className="grow">
      ...
      <div className="py-16 px-8 md:px-16 bg-base0 rounded-b-lg">
